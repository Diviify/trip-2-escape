    ...
    >
      <div className="relative aspect-[4/3] overflow-hidden">
        ...
        <span className="absolute left-3 top-3 inline-flex items-center gap-1 rounded-full bg-white/90 px-2.5 py-1 text-xs font-medium text-brand-primary backdrop-blur-sm">
          <MapPin className="size-3 text-brand-accent" aria-hidden />
          {destination.state}
        </span>
      ...
      <div className="flex flex-1 flex-col p-5">
        <h3 className="font-heading text-xl font-semibold text-brand-primary transition-colors group-hover:text-brand-accent">
          {destination.name}
        </h3>
